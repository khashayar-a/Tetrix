  ...
  while(!point_vector.empty() && count < 720)
    {
      ...
      result[count] = enif_make_tuple2(env , enif_make_int(env, (int) t2g.x), enif_make_int(env, (int) t2g.y));
