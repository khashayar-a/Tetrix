...
static ERL_NIF_TERM deinit_razer(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]){
...
static ErlNifFunc nif_funcs[] =
  {
    {"get_byte", 0, get_byte},
    {"deinit_razer", 0, deinit_razer}
  };

ERL_NIF_INIT(razer_nif,nif_funcs,load,NULL,NULL,NULL)
