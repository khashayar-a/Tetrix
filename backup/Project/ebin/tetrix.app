{application,tetrix,
             [{description,[]},
              ...
              {modules,[car_ai,cunit,cunit_nif,currentPos,erlport,
                        erlport_options,erlport_utils,gpio_nif,hal_nif,
                        hardware_data,hidnif,image_proc,imgproc_nif,lidar_nif,
                        map_functions,map_gen,object_detection,object_worker,
